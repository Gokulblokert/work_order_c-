...
[HttpDelete("Remove/workid")]
    ...
    [HttpPost("CreateTechh")]
     public  IActionResult CreateTechh([FromBody] TechnicianTb _tech)
    {
        try
        {
            this._DBContext.TechnicianTbs.Add(_tech);
            this._DBContext.SaveChanges();
        }
        catch (Exception)
        {
        ...
        public static bool Inserttech( _techician)  
    {  
        bool status;  
        try  
        {  
            DbContext.Techicians.Add(_techician);  
